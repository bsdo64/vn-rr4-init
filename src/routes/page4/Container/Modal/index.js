...
class Modal extends Component {
  ...
  componentDidMount() {
    this.refs.overlay1.addEventListener('scroll', this.handleScroll, false);
    this.refs.overlay1.addEventListener('wheel', this.handleScroll, false);
  }

  componentWillUnmount(){
    this.refs.overlay1.removeEventListener('scroll', this.handleScroll, false);
    this.refs.overlay1.removeEventListener('wheel', this.handleScroll, false);
  }

  render() {
    return (
      <div>
        <div className="overlay" ref="overlay1" style={{
          position: 'fixed',
          top: 0,
          bottom: 0,
          right: 0,
